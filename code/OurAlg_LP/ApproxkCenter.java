...
public class ApproxkCenter {

    public static int k, N;
    public static ArrayList<Point> pointList;
    public static ArrayList<ArrayList<Integer>> cannotLinkSet, mustLinkSet;
    static float[] RMark;
    public static long timeLP3 = 0;
    static float R, errorBar, Rmax, Rmin;
    static ArrayList<Integer> must = new ArrayList<>(), centers;

    public ApproxkCenter(ArrayList<Point> pointList, ArrayList<ArrayList<Integer>> CannotList, ArrayList<ArrayList<Integer>> MustList, int k, float[] RMark) {
    ...
    public float[] Our_LP(Random r) {
        System.out.println("Our_LP:___________________________________________");
        N = pointList.size();
        float[] accuracy;
        timeLP3 = 0;
        Rmax = RMark[0];
        ...
        accuracy = Metrics.metrics(N, pointList, centers, k, times + ", " + timeLP3);
        return accuracy;
    }
