...
public class Approx_greedy_matching_kCenter {

    public static int k, N;
    public static ArrayList<Point> pointList;
    public static ArrayList<ArrayList<Integer>> cannotLinkSet, mustLinkSet;
    static float[] RMark;
    public static long timeGM3 = 0;
    static float R, errorBar, Rmax, Rmin;
    static ArrayList<Integer> must = new ArrayList<>(), centers;

    public Approx_greedy_matching_kCenter(ArrayList<Point> pointList, ArrayList<ArrayList<Integer>> CannotList, ArrayList<ArrayList<Integer>> MustList, int k, float[] RMark) {
    ...
    public float[] our_greedy_matching(Random r) {
        System.out.println("Approx_matching_kCenter:___________________________________________");
        N = pointList.size();
        float[] accuracy;
        timeGM3 = 0;
        ...
        accuracy = Metrics.metrics(N, pointList, centers, k, times + ", " + timeGM3);
...
//                break;
        ...
        while (!judgeCannot(R)) {
            for (List<Integer> cannotLink : cannotLinkSet) {
                ...
                if (!cannotLink.isEmpty()) {
                    Flag_change = hk.input(pointList, centers, cannotLink, mustLinkSet, R);
                }
    ...
    private String algorithm(Random r) {
        ...
        return (System.nanoTime() - startTime) + "," + time3;
    }
